...
(use-package ai-code
  ...
  ;; Use Eat as the terminal backend instead of the default vterm.
  ;; for openai codex, github copilot cli, opencode, grok, cursor-cli; for claude-code-ide.el, you can check their config
